...
module.exports = {
  ...
  MEASUREMENT_REALTIME_NAMESPACE: process.env.MEASUREMENT_REALTIME_NAMESPACE || '/realtime/v1',
  MEASUREMENT_CRITICAL_RETRY_ATTEMPTS: asNumber(process.env.MEASUREMENT_CRITICAL_RETRY_ATTEMPTS, 3),
  MEASUREMENT_IDEMPOTENCY_MAX_LENGTH: asNumber(process.env.MEASUREMENT_IDEMPOTENCY_MAX_LENGTH, 120),
  MEASUREMENT_IDEMPOTENCY_MIN_LENGTH: asNumber(process.env.MEASUREMENT_IDEMPOTENCY_MIN_LENGTH, 6),
  MEASUREMENT_IDEMPOTENCY_PATTERN: process.env.MEASUREMENT_IDEMPOTENCY_PATTERN || '^[a-zA-Z0-9][a-zA-Z0-9-]{5,119}$',
